                                            ...
                                            <div class="col-md-12">
                                                <nav>
                                                    <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                                        <a class="nav-item nav-link active" id="pdev-img-tab" data-toggle="tab" href="#pdev-image" role="tab" aria-controls="pdev-image" aria-selected="true">Image</a>
                                                        <a class="nav-item nav-link" id="pdev-vars-tab" data-toggle="tab" href="#pdev-vars" role="tab" aria-controls="pdev-vars" aria-selected="false">Variables</a>
                                                    </div>
                                                </nav>
                                                <div class="tab-content" id="nav-tabContent">
                                                    <div class="tab-pane fade show active" id="pdev-image" role="tabpanel" aria-labelledby="pdev-image-tab">
                                                        <div class="iframe-container">
                                                            <iframe id="pdefimgmodalframe" class="embed-responsive-item" src=""></iframe>
                                                            </div>
                                                    </div>
                                                    <div class="tab-pane fade" id="pdev-vars" role="tabpanel" aria-labelledby="pdev-vars-tab">
