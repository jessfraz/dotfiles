 ...
 * MIT Licensed
 */var n=i(105),o=/^text\/|\+(?:json|text|xml)$/i,s=/^\s*([^;\s]*)(?:;|\s|$)/;a.exports=function(a){if(!a||"string"!=typeof a)return!1;var e=s.exec(a),i=e&&e[1].toLowerCase(),c=n[i];if(c&&void 0!==c.compressible)return c.compressible;return o.test(i)||void 0}},947:function(a,e){a.exports=function(a){return!!a&&("string"!=typeof a&&("function"!=typeof a.pipe&&!Buffer.isBuffer(a)))}}});
//# sourceMappingURL=koa-compress.js.map